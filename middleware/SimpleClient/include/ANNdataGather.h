 ...
 *                                                                         *
 ***************************************************************************/
#ifndef ANNDATAGATHER_H
#define ANNDATAGATHER_H
...
class ANNdataGather : public WrapperBaseDriver
{
public:
	
	// Constructor
	ANNdataGather(){ stuck = 0; clutch = 0.0; samples = 0; };
